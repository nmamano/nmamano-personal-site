...
\begin{description}
\item[Languages]\quad C++, C, Python, Java, Javascript, Bash, HTML, CSS, SQL.
...
\vspace{-3px}
\begin{description}
	\item[Software Engineer]\hfill Feb 2021 -- Present
	
	Working on efficient network utilization.
...
\vspace{-3px}
\begin{description}
	\item[Teacher]\hfill Apr 2020 -- Jan 2021
	
	Led the redesign and development of the ADS curriculum (Algorithms and Data Structures). Prepared 100+ students for coding interviews by teaching algorithms and conducting mock interviews.
\end{description}
